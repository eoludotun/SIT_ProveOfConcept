...
public class Driver {
    ...
    public static WebDriver initialiseEndToEndDriver() {
        setSystemsProperties();
        aDriver = new ChromeDriver();
        log().info("Current Browser is End to End : " + aDriver);
        log().info(aDriver);
        aDriver.manage().timeouts().implicitlyWait(30L, TimeUnit.SECONDS);
        return aDriver;
    }
...
//    	    if(option2.getText().equals(option)) {
//    	      option2.click();       
//    	    }               
//    	}
		return selected; 
